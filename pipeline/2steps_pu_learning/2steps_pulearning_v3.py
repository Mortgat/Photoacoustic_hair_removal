...
# ==========================================
# CONFIGURATION V5.1 (SANS CANAL DISTANCE)
# ==========================================
...
class StandardUNet3DAniso(nn.Module):
    # in_channels réduit à 1 (uniquement le volume brut)
...
# ==========================================
# DATALOADER (UN SEUL CANAL)
# ==========================================
class PUStrictDataset(Dataset):
    def __init__(self, vol, pos, hn, vs, easy_neg, p_xy=PATCH_XY, p_z=PATCH_Z, iters=400):
        self.vol = vol
    ...
    def __getitem__(self, idx):
        ...
        def get_patch(x, y, z):
            ...
            # Plus de canal dist, uniquement le volume
...
def main():
    ...
    # Création du easy_neg pour le dataloader (Toujours basé sur la géométrie)
    nz = vol.shape[2]
    ...
    dataset = PUStrictDataset(vol, pos, hn, vs, easy_neg)
    loader = DataLoader(dataset, batch_size=1, shuffle=True)

    model = StandardUNet3DAniso(in_channels=1, base=32).to(device)
